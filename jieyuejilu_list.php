...
<form id="form1" name="form1" method="post" action="">
  ...
  借取人：<input name="jiename" type="text" id="jiename" size="15" /> 
  借取学号：<input name="stu_number" type="text" id="stu_number" size="15" /> 
  是否归还：
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>借取人</td>
    <td bgcolor='#CCFFFF'>借取学号</td>
  ...
  <?php 
    ...
    if ($_POST["jiename"]!="")
      {
        $nreq=$_POST["jiename"];
        $sql=$sql." and jiename like '%$nreq%'";
      }
    if ($_POST["stu_number"]!="")
      {
        $nreq=$_POST["stu_number"];
        $sql=$sql." and stu_number like '%$nreq%'";
      }  
    if ($_POST["isguihuan"]!="")
      {
  ...
  <tr>
    ...
    <td><?php echo mysql_result($query,$i,'jiename');?></td>
    <td><?php echo mysql_result($query,$i,'stu_number');?></td>
